...
public class LL {
	...
	public void deleteAll(int c){//taking 4 cases, if the element to be deleted is the head of linkedlist and is the only elements of the linked list, if it is at the end, if it is in the middle and if it is the head with elements after it
		if(head==null)
